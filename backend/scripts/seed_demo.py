...
ITEM_CATALOG: dict[str, tuple[str, float, str, float | None, str | None]] = {
    ...
    "Casein Nocturne 1KG": ("Health & Beauty", 39.99, "ea", 32, "casein"),
    ...
    "Inference-Grade Protein Bars 12ct": (
        "Health & Beauty",
        26.99,
        "ea",
        25,
    ...
    # ---- Household ----
    "Functional Surfactant (Lemon-ish) 32oz": ("Household", 4.89, "ea", None, None),
...
STORE_CATALOG: dict[str, list[str]] = {
    "VendorVics": [
        "Spotted Bananas",
        "Organicish Fuji Apples",
        "Broccoli Chunks",
        "Whole Milk (The Good Kind) 64oz",
        "Cage-Ish Free Eggs 12ct",
        "Unsalted Fancy Butter 1lb",
        "Beef That's Mostly Lean",
        "Sourdough Vibes Loaf 24oz",
        "Old-Fashioned Oats 42oz",
        "Beans (Black, Canned) 15oz",
        "Penne Pasta 1lb",
        "Tomato Sauce Classic 24oz",
        "OJ (With Pulp) 52oz",
        "Bubbly Water 12pk",
        "Margherita Pizza (Fancy) 14oz",
        "Sea Salt Kettle Chips 8oz",
        "Paper Towels (Strong) 6-Roll",
    ...
    "SpaceWay": [
        ...
        "Cage-Ish Free Eggs 12ct",
        "Fancy Sharp Cheddar 2lb",
        "Free-Range Chicken Breast",
        "Big Shrimp (Frozen Bag) 2lb",
        "Multigrain Everything Bagels 6ct",
        "Penne Pasta 1lb",
        "Tomato Sauce Classic 24oz",
        "Flour, All-Purpose-ish 5lb",
        "Electrolyte Drink (Melon) 20oz",
        "Bubbly Water 12pk",
        "Cauliflower Crust Pizza 11oz",
        "Edamame Beans 2lb",
        "Hummus Original 17oz",
        "Rice Cakes (Plain Sadness) 4oz",
    ...
    "WhollyFUD": [
        ...
        "Extra Virginal Olive Oil 25oz",
        "Quinoa (Pronounce At Own Risk) 4lb",
        "Suspiciously Delicious Almond Butter 16oz",
        "Coconut Aminos (Fancy Soy Sauce) 10oz",
        "Cold Brew Concentrate 32oz",
        "Funky Fermented Tea 16oz",
    ...
    "Salsa Emporium": [
        "Salsa Verde Vortex 16oz",
        "Mango Habanero Situation 16oz",
        "Salsa Roja: The Original 24oz",
        "Ghost Pepper Regret Sauce 5oz",
        "Restaurant-Style Tortilla Chips 20oz",
    ...
    "B2BSaasoons": [
        ...
        "Everything Bagel Seasoning API 6oz",
        "Garlic Powder (Per-Seat License) 8oz",
        "Cumin Subscription Refill 3oz",
        "Taco Seasoning SLA 1oz",
        "Cinnamon Sticks (Annual Contract) 2oz",
    ],
    "LuridLurie's Gas": [
        "Gas Station Sushi (Brave) 8oz",
        "Neon Energy Sludge 16oz",
    ...
    "Tartanula's": [
        "Strawberry Tartlette Flight 6ct",
        "Tartan Plaid Shortbread Tin 12oz",
